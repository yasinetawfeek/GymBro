...
def mediapipe_format_dataset_handler(dataset_name):
    try:
        ...
        train_with_noise.to_csv(current_dir + '/../../data/datasets/train.csv')
        test_with_noise.to_csv(current_dir + '/../../data/datasets/test.csv')
        validation_with_noise.to_csv(current_dir + '/../../data/datasets/validation.csv')
