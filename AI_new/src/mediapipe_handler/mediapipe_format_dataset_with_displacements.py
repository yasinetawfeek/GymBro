...
def mediapipe_format_dataset_handler(dataset_name):
    try:
        ...
        print("saving...")
        train_with_noise.to_csv(current_dir + '/../../data/datasets/train_with_displacement.csv')
        test_with_noise.to_csv(current_dir + '/../../data/datasets/test_with_displacement.csv')
        validation_with_noise.to_csv(current_dir + '/../../data/datasets/validation_with_displacement.csv')
